...
original_image = Image.open(io.BytesIO(image_data)) # binary stream
...
encrypted_image_data = np.pad(encrypted_image_data, (0, image_size**2 * 3 - len(encrypted_image_data)), mode='constant') # constant is 0 by default and 
