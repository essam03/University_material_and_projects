...
<body>
    <div class="container">
       ...
       <a href="http://localhost/Final%20assignmnet/php/booking2.php"> <button type="submit">Login</button></a><!-- SEO: Button for user login with clear text -->
        <a href="http://localhost/Final%20assignmnet/php/sign%20in.php"> <!-- SEO: Button for user registration with clear text -->
            <button type="button">Register</button>
        </a>
        <a href="#" id="forget">I forgot my password</a><!-- SEO: Link for password recovery -->
    </div>
</body>
</html>
