...
def compare_user_code(user_code_text, db_patterns, threshold=0.60):
...
if __name__ == '__main__':
    user_code_path = "C:/Users/User/Downloads/disassembly_output1.asm"
    ...
    if not matches:
        ...
        table = [
            [m['similarity'], m['title'], m['category'], m['attack_type'], m['risk']]
            for m in matches
        ]
        print(tabulate(table, headers=["Similarity", "Title", "Category", "Attack Type", "Risk"], tablefmt="fancy_grid"))
